...
const toastClasses = computed(() => {
  const baseClasses =
    'flex items-start p-4 rounded-lg shadow-lg border-l-4 mb-3 transition-all duration-300 ease-in-out transform';

  const typeClasses = {
    success:
      'bg-green-100 dark:bg-green-800 border-green-500 text-green-800 dark:text-green-100',
    error:
      'bg-red-100 dark:bg-red-800 border-red-500 text-red-800 dark:text-red-100',
    info: 'bg-blue-100 dark:bg-blue-800 border-blue-500 text-blue-800 dark:text-blue-100',
    warning:
      'bg-yellow-100 dark:bg-yellow-800 border-yellow-500 text-yellow-800 dark:text-yellow-100',
  };
