...
const currentTheme = computed(
  () =>
    auth.user?.config?.Theme as 'light' | 'dark' | 'system' | 'high-contrast'
);
...
<template>
  <AppLayout>
    ...
    <div class="space-y-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div
                ...
                class="rounded-lg p-4 cursor-pointer transition-all duration-200 hover:shadow-md card-option"
                :class="[
                  currentTheme === 'system'
                    ? 'card-option--selected shadow-md'
                    : '',
              ...
              <div
                @click="changeTheme('high-contrast')"
                class="rounded-lg p-4 cursor-pointer transition-all duration-200 hover:shadow-md card-option"
                :class="[
              ...
              >
                <div class="flex items-center">
                  ...
                  <div
                    v-if="currentTheme === 'high-contrast'"
                    class="text-red-500"
                  >
                    <CheckCircleIcon class="h-5 w-5" />
                  </div>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              ...
              >
                <input
                  type="checkbox"
                  v-model="localConfig.HideThumbnail"
                  @change="saveConfig"
                ...
                <div>
                  <span
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t('settings.hide_thumbnail') }}
                  </span>
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ t('settings.hide_thumbnail_description') }}
                  </p>
                </div>
              </label>
              <label
              ...
              >
                <input
                  type="checkbox"
                  v-model="localConfig.HideExcerpt"
                  @change="saveConfig"
                  class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
                <div>
                  <span
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
                    {{ t('settings.hide_excerpt') }}
                  </span>
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ t('settings.hide_excerpt_description') }}
                  </p>
                </div>
              </label>
            </div>
      ...
      <div
        v-if="isOwner"
        class="bg-white dark:bg-gray-800 p-6 rounded-md shadow-sm"
      >
        <div class="flex items-center mb-4">
          <div
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
          {{ t('settings.bookmarks_description') }}
        </p>
        <div class="space-y-3">
          <label
            class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          >
            <input
              type="checkbox"
              v-model="localConfig.KeepMetadata"
              @change="saveConfig"
              class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <div>
              <span
                class="text-sm font-medium text-gray-700 dark:text-gray-300"
              >
                {{ t('settings.keep_metadata') }}
              </span>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('settings.keep_metadata_description') }}
              </p>
            </div>
          </label>
          <label
          ...
          >
            <input
              type="checkbox"
              v-model="localConfig.UseArchive"
              @change="saveConfig"
              class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <div>
              <span
                class="text-sm font-medium text-gray-700 dark:text-gray-300"
              >
                {{ t('settings.use_archive') }}
              </span>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('settings.use_archive_description') }}
              </p>
            </div>
          </label>
          <label
          ...
          >
            <input
              type="checkbox"
              v-model="localConfig.CreateEbook"
              @change="saveConfig"
              class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <div>
              <span
                class="text-sm font-medium text-gray-700 dark:text-gray-300"
              >
                {{ t('settings.create_ebook') }}
              </span>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('settings.create_ebook_description') }}
              </p>
            </div>
          </label>
          <label
          ...
          >
            <input
              type="checkbox"
              v-model="localConfig.MakePublic"
              @change="saveConfig"
              class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <div>
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {{ t('settings.make_public_description') }}
              </p>
            </div>
          </label>
        </div>
