(() => {
	...
	__export(exports_esm, {
		...
		instanceOfApiV1UpdateBookmarkPayload: () =>
			instanceOfApiV1UpdateBookmarkPayload,
		instanceOfApiV1UpdateAccountPayload: () =>
			instanceOfApiV1UpdateAccountPayload,
		instanceOfApiV1ReadableResponseMessage: () =>
			instanceOfApiV1ReadableResponseMessage,
		instanceOfApiV1LoginResponseMessage: () =>
			instanceOfApiV1LoginResponseMessage,
		instanceOfApiV1LoginRequestPayload: () =>
			instanceOfApiV1LoginRequestPayload,
		instanceOfApiV1InfoResponseVersion: () =>
			instanceOfApiV1InfoResponseVersion,
		instanceOfApiV1InfoResponse: () => instanceOfApiV1InfoResponse,
		instanceOfApiV1DeleteBookmarksPayload: () =>
			instanceOfApiV1DeleteBookmarksPayload,
		instanceOfApiV1CreateBookmarkPayload: () =>
			instanceOfApiV1CreateBookmarkPayload,
		instanceOfApiV1BulkUpdateBookmarkTagsPayload: () =>
			instanceOfApiV1BulkUpdateBookmarkTagsPayload,
	...
	function ApiV1BulkUpdateBookmarkTagsPayloadFromJSONTyped(
		json,
		ignoreDiscriminator,
	) {
		if (json == null) {
	...
	function ApiV1InfoResponseVersionToJSONTyped(
		value,
		ignoreDiscriminator = false,
	) {
		if (value == null) {
	...
	function ApiV1LoginResponseMessageToJSONTyped(
		value,
		ignoreDiscriminator = false,
	) {
		if (value == null) {
	...
	function ApiV1ReadableResponseMessageToJSONTyped(
		value,
		ignoreDiscriminator = false,
	) {
		if (value == null) {
	...
	function ApiV1UpdateAccountPayloadFromJSONTyped(json, ignoreDiscriminator) {
		...
		return {
			...
			newPassword:
				json["new_password"] == null ? undefined : json["new_password"],
			oldPassword:
				json["old_password"] == null ? undefined : json["old_password"],
	...
	function ApiV1UpdateCachePayloadFromJSONTyped(json, ignoreDiscriminator) {
		...
		return {
			...
			ids: json["ids"],
			keepMetadata:
				json["keep_metadata"] == null ? undefined : json["keep_metadata"],
	...
	function ModelBookmarkDTOToJSONTyped(value, ignoreDiscriminator = false) {
		...
		return {
			...
			tags:
				value["tags"] == null
					? undefined
					: value["tags"].map(ModelTagDTOToJSON),
			title: value["title"],
			url: value["url"],
		};
	}
	...
	class AccountsApi extends BaseAPI {
		...
		apiV1AccountsIdPatch(requestParameters, initOverrides) {
			return __awaiter2(this, undefined, undefined, function* () {
				const response = yield this.apiV1AccountsIdPatchRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
	...
	class AuthApi extends BaseAPI {
		...
		apiV1AuthAccountPatch() {
			return __awaiter3(
				...
				function* (requestParameters = {}, initOverrides) {
					const response = yield this.apiV1AuthAccountPatchRaw(
						requestParameters,
						initOverrides,
					);
					return yield response.value();
		...
		apiV1AuthLoginPost() {
			return __awaiter3(
				...
				undefined,
				function* (requestParameters = {}, initOverrides) {
					const response = yield this.apiV1AuthLoginPostRaw(
						requestParameters,
						initOverrides,
					);
					return yield response.value();
	...
	class BookmarksApi extends BaseAPI {
		...
		apiV1BookmarksBulkTagsPut(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response = yield this.apiV1BookmarksBulkTagsPutRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
		...
		apiV1BookmarksCachePut(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response = yield this.apiV1BookmarksCachePutRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
				...
				const response = yield this.request(
					{
						...
						headers: headerParameters,
						query: queryParameters,
						body: ApiV1DeleteBookmarksPayloadToJSON(
							requestParameters["payload"],
						),
					},
					initOverrides,
		...
		apiV1BookmarksGet() {
			return __awaiter4(
				...
				undefined,
				function* (requestParameters = {}, initOverrides) {
					const response = yield this.apiV1BookmarksGetRaw(
						requestParameters,
						initOverrides,
					);
					return yield response.value();
		...
		apiV1BookmarksIdGet(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response = yield this.apiV1BookmarksIdGetRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
				...
				const response = yield this.request(
					{
						...
						headers: headerParameters,
						query: queryParameters,
						body: ApiV1UpdateBookmarkPayloadToJSON(
							requestParameters["payload"],
						),
					},
					initOverrides,
		...
		apiV1BookmarksIdPut(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response = yield this.apiV1BookmarksIdPutRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
		...
		apiV1BookmarksIdReadableGet(initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response =
					yield this.apiV1BookmarksIdReadableGetRaw(initOverrides);
				return yield response.value();
			});
		}
		...
		apiV1BookmarksIdTagsDelete(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				yield this.apiV1BookmarksIdTagsDeleteRaw(
					requestParameters,
					initOverrides,
				);
			});
		...
		apiV1BookmarksIdTagsGet(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response = yield this.apiV1BookmarksIdTagsGetRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
		...
		apiV1BookmarksIdTagsPost(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				yield this.apiV1BookmarksIdTagsPostRaw(
					requestParameters,
					initOverrides,
				);
			});
				...
				const response = yield this.request(
					{
						...
						headers: headerParameters,
						query: queryParameters,
						body: ApiV1CreateBookmarkPayloadToJSON(
							requestParameters["payload"],
						),
					},
					initOverrides,
		...
		apiV1BookmarksPost(requestParameters, initOverrides) {
			return __awaiter4(this, undefined, undefined, function* () {
				const response = yield this.apiV1BookmarksPostRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
	...
	class TagsApi extends BaseAPI {
		...
		apiV1TagsGet() {
			return __awaiter6(
				...
				undefined,
				function* (requestParameters = {}, initOverrides) {
					const response = yield this.apiV1TagsGetRaw(
						requestParameters,
						initOverrides,
					);
					return yield response.value();
		...
		apiV1TagsIdGet(requestParameters, initOverrides) {
			return __awaiter6(this, undefined, undefined, function* () {
				const response = yield this.apiV1TagsIdGetRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
		...
		apiV1TagsIdPut(requestParameters, initOverrides) {
			return __awaiter6(this, undefined, undefined, function* () {
				const response = yield this.apiV1TagsIdPutRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
		...
		apiV1TagsPost(requestParameters, initOverrides) {
			return __awaiter6(this, undefined, undefined, function* () {
				const response = yield this.apiV1TagsPostRaw(
					requestParameters,
					initOverrides,
				);
				return yield response.value();
