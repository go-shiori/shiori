...
func GenerateEbook(req ProcessRequest, dstPath string) (book model.Bookmark, err error) {
	...
	lastline := `<p style="text-align:center"> Generated By Shiori From <a href="` + book.URL + `">This Page</a></p>`
	...
	ebook.AddSection(string(`<h1 style="text-align:center"> `+book.Title+` </h1>`+book.HTML+lastline), book.Title, "", "")
	ebook.EmbedImages()
